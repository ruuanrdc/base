...
vRP.prepare("vRP/update_winrace","UPDATE vrp_races SET vehicle = @vehicle, date = @date, points = @points WHERE user_id = @user_id and raceid = @raceid")
vRP.prepare("vRP/insert_winrace","INSERT INTO vrp_races(user_id,vehicle,raceid,date,points) VALUES(@user_id,@vehicle,@raceid,@date, @points)")
